...
import { SIGN_IN_USER } from '../schemas';
  ...
  return (
    <Layout>
      ...
      <Text fontSize='3xl'>Test .env: {SECRET}</Text>
        ...
        ) : loading ? <Text fontSize='xl'>Loading...</Text> : null 
        }
        <Button onPress={() => props.navigation.navigate('Friends')}>Go to friends screen</Button>
      </View>
    </Layout>
  )
}
